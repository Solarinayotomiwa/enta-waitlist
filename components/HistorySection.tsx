    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <img
          ...
          /* Literal path: the historySky key was dropped from figmaAssets when
             the section was removed from main; the asset itself is restored on
             this branch. */
          src="/assets/figma/history/history-sky.png"
        />
