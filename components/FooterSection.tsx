...
/* Brand glyphs exported from Figma node 830:3074 (viewBox 0 0 40 40). ENTA has
   no LinkedIn presence, so that icon points at the parent company Shiga
   Digital; the TikTok glyph is drawn on a 256 grid and carries its own
   viewBox. */
const socialLinks: readonly {
  ...
  },
  {
    ...
    viewBox: "0 0 256 256",
    path: "M224,72a48.05,48.05,0,0,1-48-48,8,8,0,0,0-8-8H128a8,8,0,0,0-8,8V156a20,20,0,1,1-28.57-18.08,8,8,0,0,0,4.57-7.23V88a8,8,0,0,0-9.4-7.88C50.91,86.48,24,119.1,24,156a76,76,0,0,0,152,0V116.29A103.25,103.25,0,0,0,224,128a8,8,0,0,0,8-8V80A8,8,0,0,0,224,72Z",
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/shigadigital/",
              ...
              {socialLinks.map((social) => (
                ...
                >
                  <svg
                    ...
                    className="size-10"
                    fill="currentColor"
                    viewBox={social.viewBox ?? "0 0 40 40"}
                  >
                    <path d={social.path} />
                  </svg>
                </a>
